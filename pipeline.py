...
LUA_SHA1 = get_hash(os.path.join(CWD, 'zippyshare.lua'))
...
project = Project(
    title='Zippyshare',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/2/23/Zippyshare_logo.png" height="50px" title=""/>
        <h2>zippyshare.com <span class="links"><a href="https://zippyshare.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/zippyshare/">Leaderboard</a></span></h2>
        <p>Archiving Zippyshare.</p>
    '''
)
